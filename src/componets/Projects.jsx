...
const ProjectSection = () => {
  const projects = [
    {
      ...
      videoSrc: 'src/assets/Product filter app in js.mp4',
      thumbnail: 'src/assets/Product filter app in js.png',
    ...
    },
    {
      ...
      videoSrc: 'src/assets/Product Filter app in react.mp4',
      thumbnail: 'src/assets/Product Filter app in react.jpg',
...

    {
      ...
      videoSrc: 'src/assets/html css js restorent site.mp4',
      thumbnail: 'src/assets/html css js restorent site.jpg',
       technologies: [<FaJsSquare className='text-yellow-400'/>, <FaCss3Alt  className='text-blue-400'/>, <FaHtml5  className='text-orange-500'/>],
    },
      ...
      videoSrc: 'src/assets/marks calculator js.mp4',
      thumbnail: 'src/assets/marks calculator js.jpg',
      technologies: [<FaJsSquare className='text-yellow-400'/>, <FaCss3Alt  className='text-blue-400'/>, <FaHtml5  className='text-orange-500'/>],
    },
      ...
      videoSrc: 'src/assets/to do list app react.mp4',
      thumbnail: 'src/assets/to do list app react.jpg',
       technologies: [<FaReact className='text-blue-600' />, <FaCss3Alt  className='text-blue-400'/>, <FaHtml5  className='text-orange-500'/>],
    },
      ...
      videoSrc: 'src/assets/react quiz app.mp4',
      thumbnail: 'src/assets/quiz app react.jpg',
       technologies: [<FaReact className='text-blue-600' />, <FaCss3Alt  className='text-blue-400'/>, <FaHtml5  className='text-orange-500'/>],
    },
      ...
      videoSrc: 'src/assets/quiz app js.mp4',
      thumbnail: 'src/assets/quiz app js.jpg',
       technologies: [<FaJsSquare className='text-yellow-400' />, <FaCss3Alt className='text-blue-400' />, <FaHtml5  className='text-orange-500'/>],
    },
      ...
      videoSrc: 'src/assets/Bootsrap organic.mp4',
      thumbnail: 'src/assets/Bootsrap organic.jpg',
    ...
    
     {
      ...
      videoSrc: 'src/assets/portfolio.mp4',
      thumbnail: 'src/assets/portfolio.jpg',
        technologies: [<FaBootstrap  className='text-blue-500'/>, <FaHtml5  className='text-orange-500'/>],
    },
  ...
  return (
    <section className="project-section py-16 bg-gray-900 p-4 dark:bg-gradient-to-r dark:from-indigo-1000 dark:via-purple-900 dark:to-pink-800 dark:text-white text-gray-700 bg-gradient-to-r from-indigo-400 via-purple-500 to-pink-200">
      <h2 className="text-3xl font-semibold text-white text-center mb-8">My Projects</h2>
      <div className="projects-grid grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 px-4 ">
